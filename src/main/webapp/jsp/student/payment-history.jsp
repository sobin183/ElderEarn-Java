...
<head>
    ...
    <title>My Payments - Student Portal</title>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1">My Payment History</h2>
                    <p class="text-muted mb-0">Review all your payments for skill subscriptions and marketplace digital resources.</p>
                </div>
            </div>
                        ...
                        <tbody>
                            <%
                                ...
                                try {
                                    ...
                                    String sql = "SELECT * FROM payments WHERE student_name = ? ORDER BY payment_id DESC";
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-muted py-5">
                                    <i class="bi bi-credit-card-2-back fs-1 mb-2 d-block"></i>
