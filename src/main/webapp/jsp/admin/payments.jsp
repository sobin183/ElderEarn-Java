    ...
    <div class="container-fluid p-0">
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1">Payments & Transactions</h2>
                    <p class="text-muted mb-0">Monitor all student-to-teacher payments processed across the platform.</p>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-custom mb-0">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td colspan="7" class="text-center text-muted py-5">No payments found.</td>
                            </tr>
                            <%
                                    }
                                } catch (Exception e) {
