    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (idStr == null || idStr.trim().isEmpty()) {
                response.sendRedirect("jsp/teacher/view-my-skills.jsp?error=invalid_id");
                return;
            }
            ...
            String sql = "DELETE FROM skills WHERE skill_id = ? AND teacher_name = ?";
            ...
            if (rowsDeleted > 0) {
                response.sendRedirect("jsp/teacher/view-my-skills.jsp?success=deleted");
            } else {
                response.sendRedirect("jsp/teacher/view-my-skills.jsp?error=not_found");
            }
